"""
Core deliberation models: discussions, statements, participants, votes,
responses, evidence, and the adjacent view/follow/notify/update
infrastructure plus the journey-reminder email subscription.

This is the largest single domain — it carries the weight of the app.
Classes moved here from app/models.py as part of the models-split
refactor:

  DiscussionView, Notification,
  DiscussionFollow, DiscussionUpdate, DiscussionParticipant,
  Discussion, Statement, StatementVote, Response, Evidence,
  JourneyReminderSubscription, StatementFlag

No event listeners in this block. Cross-domain relationships (User,
