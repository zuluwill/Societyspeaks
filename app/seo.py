...
def generate_sitemap():
    ...
    xml_content.extend([
        ...
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/big-questions-journey</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/daily-question</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/daily-brief</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/news-dashboard</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/civic-infrastructure</loc>',
        '    <priority>0.8</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/personal-briefs</loc>',
        '    <priority>0.6</priority>',
        '    <changefreq>monthly</changefreq>',
        '  </url>',
        '  <url>',
        f'    <loc>{base_url}/help/programmes</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
    ])
    if current_app.config.get('GAME_ENABLED', True):
        xml_content.extend([
        '  <url>',
        f'    <loc>{base_url}/help/tradeoffs</loc>',
        '    <priority>0.7</priority>',
        '    <changefreq>weekly</changefreq>',
        '  </url>',
        ])
