...
# Email delivery does NOT branch on this hour — sends always use
# DailyBrief.get_latest_published() at each subscriber's local send hour.
# Before publish, "latest published" is naturally the prior edition; after
# publish, it is today's. Subscribers east of UTC whose local evening precedes
# this hour receive the prior calendar-dated edition once per local day (by design).
