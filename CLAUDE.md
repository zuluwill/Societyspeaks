...
- **Production hosting:** Render (Frankfurt) + Neon London + S3 London + Upstash. Deploy checklist: [RENDER_DEPLOY.md](./RENDER_DEPLOY.md). Do not treat Replit as production source of truth.
