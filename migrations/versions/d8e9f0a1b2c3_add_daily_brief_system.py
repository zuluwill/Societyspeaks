...
def upgrade():
    # Add political leaning columns to news_source
    with op.batch_alter_table('news_source', schema=None) as batch_op:
        batch_op.add_column(sa.Column('political_leaning', sa.Float(), nullable=True))
        batch_op.add_column(sa.Column('leaning_source', sa.String(length=50), nullable=True))
        batch_op.add_column(sa.Column('leaning_updated_at', sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column('country', sa.String(length=100), nullable=True))

    # Create brief_team table
    ...
    # Create daily_brief_subscriber table
